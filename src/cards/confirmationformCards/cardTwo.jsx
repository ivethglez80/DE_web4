...
const CardTwo = ({ form, onChangeHandler, onSubmit, onNext, onPrev, errors }) => {
    ...
    return (
        <>
            <div className="border border-color3 m-2 rounded-3xl">
                ...
                <div className="flex flex-col w-2/3 items-center mx-auto">
                    <p className="font-fuente4 text-xs text-center mt-4 mb-10 mx-auto text-color3">Ingresa la cantidad de personas que confirmas, En caso de haber registrado una familia, ingresá todos los integrantes</p>
                    <div className="flex flex-row justify-center pb-10 z-[70] md:pt-3">
                        <FaMinusCircle onClick={decreaseQty} className="cursor-pointer text-color3 hover:text-musgo2 text-4xl mr-4" />
                        <span className="mx-2 font-fuente4 text-3xl text-color3">{quantity}</span>
                        <FaCirclePlus onClick={increaseQty} className="cursor-pointer text-color3 hover:text-musgo2 text-4xl ml-4" />
                    </div>
                </div>
                ...
                {quantity === 0 ?
                    ...
                    :
                    <div className="flex justify-center md:justify-end md:pr-10">
                        <button onClick={onSubmit} className="border border-color3 text-sm rounded-3xl py-2 w-5/6  bg-white">{errors.sbmt ? errors.sbmt : "finalizar y enviar" }</button>
